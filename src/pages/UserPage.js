...
function UserPage() {
  ...
  return (
    <div className="relative w-10/12 mx-auto flex flex-col justify-center">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-3 mb-8">
        <div className="card image-full">
          ...
          <div className="card-body justify-end">
            ...
            <h2 className="card-title text-white text-sm">{user?.login}</h2>
          </div>
        </div>
        {/* content */}
        <div className="col-span-2">
          ...
          <div className="stats bg-base-200 shadow-xl stats-vertical w-full md:stats-horizontal">
            <div className="stat">
      ...
      <div className="stats shadow-xl bg-base-200 stats-vertical lg:stats-horizontal">
        <div className="stat">
          <div className="stat-figure text-secondary">
            <FaUsers className="text-3xl" />
          </div>
          <div className="stat-title">Followers</div>
          <div className="stat-value">{user?.followers || "No Data"}</div>
        </div>
        <div className="stat">
          <div className="stat-figure text-secondary">
          ...
          <div className="stat-value">{user?.following || "No Data"}</div>
        </div>
        <div className="stat">
          <div className="stat-figure text-secondary">
